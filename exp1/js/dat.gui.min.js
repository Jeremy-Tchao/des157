        ...
        each: function(a, d, f) {
            if (e && a.forEach === e)
                ...
                for (var b = 0, n = a.length; b < n; b++) {
                    if (b in a && d.call(f, a[b], b) === this.BREAK)
                        break
                }
            else
                for (b in a)
                    ...
                    if (b.className !== void 0)
                        if (b.className === a)
                            ...
                            var d = b.className.split(/ +/),
                                c = d.indexOf(a);
                            if (c != -1)
                                d.splice(c, 1), b.className = d.join(" ")
                        }
                } else
                    b.className = void 0;
                return f
...
dat.controllers.NumberControllerBox = function(e, a, c) {
    var d = function(f, b, e) {
        ...
        a.bind(this.__input, "keydown", function(a) {
            if (a.keyCode === 13)
                l.__truncationSuspended = true, this.blur(), l.__truncationSuspended = false
        });
        this.updateDisplay();
...
dat.color.interpret = function(e, a) {
    ...
    return function() {
        ...
        a.each(f, function(e) {
            if (e.litmus(b))
                return a.each(e.conversions, function(e, f) {
                    c = e.read(b);
                    if (d === false && c !== false)
...
dat.GUI = dat.gui.GUI = function(e, a, c, d, f, b, n, h, j, m, l, o, y, g, i) {
    function q(a, b, r, c) {
        ...
        if (c.before instanceof f)
            c.before = c.before.__li;
        t(a, b);
    ...
    function p(a, d, c) {
        ...
        i.extend(c, {
            options: function(b) {
                if (arguments.length > 1)
                    return c.remove(), q(a, c.object, c.property, {
        ...
        if (c instanceof j) {
            ...
            g.addClass(d, "color"), c.updateDisplay = i.compose(function(a) {
    ...
    var x,
        ...
        k = function(a) {
            ...
            if (a.autoPlace && i.isUndefined(a.scrollable))
                a.scrollable =
                true;
    ...
    i.extend(k.prototype, {
        ...
        remember: function() {
            if (i.isUndefined(x))
                x = new y, x.domElement.innerHTML = a;
            if (this.parent)
...
dat.controllers.factory = function(e, a, c, d, f, b, n) {
    return function(h, j, m, l) {
        var o = h[j];
        if (n.isArray(m) || n.isObject(m))
            return new e(h, j, m);
        if (n.isNumber(o))
            return n.isNumber(m) && n.isNumber(l) ? new c(h, j, m, l) : new a(h, j, {
                min: m,
                max: l
            });
        if (n.isString(o))
