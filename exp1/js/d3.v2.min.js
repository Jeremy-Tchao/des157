(function() {
        ...
        return a.id = b, a.time = c, a.tween = function(b, c) {
            ...
            return bA(a, function(a, h, i) {
                ...
                var j = [],
                    k = a.delay,
                    l = a.duration,
                    m = (a = a.node).__transition__ || (a.__transition__ = {
                        active: 0,
                        count: 0
                    }),
                    n = a.__data__;
    ...
    function bW() {
        var a = null,
            ...
            c = Infinity;
        while (b)
            b.flush ? b = a ? a.next = b.next : bS = b.next : (c = Math.min(c, b.then + b.delay), b = (a = b).next);
        return c
    }
    function bY(a) {
        var b = [a.a, a.b],
    ...
    function cg(a, b) {
        ...
        if (g = f - e)
            b = b(g), a[c] = b.floor(e), a[d] = b.ceil(f);
        return a
    }
    function ch() {
        return Math
    ...
    function cK(a) {
        function h(e) {
            ...
            var h = [],
                ...
                n = p(c);
            while (++j < k)
                d.call(this, l = e[j], j) ? i.push([+m.call(this, l, j), +n.call(this, l, j)]) : i.length && (o(), i = []);
    ...
    function cZ(a) {
        ...
        b = [c_(dc, g), ",", c_(dc, h)], --c;
        while (++c < e)
            f = a[c % d], g.shift(), g.push(f[0]), h.shift(), h.push(f[1]), dd(b, g, h);
        return b.join("")
    }
    function c$(a, b) {
        var c = a.length - 1;
    ...
    function dg(a) {
        var b = [],
            ...
            i = a.length - 1;
        while (++h < i)
            c = de(a[h], a[h + 1]), Math.abs(c) < 1e-6 ? g[h] = g[h + 1] = 0 : (d = g[h] / c, e = g[h + 1] / c, f = d * d + e * e, f > 9 && (f = c * 3 / Math.sqrt(f), g[h] = f * d, g[h + 1] = f * e));
        h = -1;
        while (++h <= i)
    ...
    function di(a) {
        var b,
            ...
            f;
        while (++c < d)
            b = a[c], e = b[0], f = b[1] + cE, b[0] = e * Math.cos(f), b[1] = e * Math.sin(f);
        return a
    }
    function dj(a) {
        function l(g) {
            ...
            var l = [],
                ...
                x;
            while (++o < q)
                f.call(this, r = g[o], o) ? (m.push([w = +s.call(this, r, o), x = +t.call(this, r, o)]), n.push([+u.call(this, r, o), +v.call(this, r, o)])) : m.length && (y(), m = [], n = []);
    ...
    function fa() {
        ...
        return o.distance = function() {
            return m == null && (n = 1 / Math.sin(m = Math.acos(Math.max(-1, Math.min(1, d * j + c * i * Math.cos(g - a)))))), m
        }, o.source = function(g) {
    ...
    d3.functor = p, d3.rebind = function(a, b) {
        ...
        if (arguments.length === 1)
            ...
            while (++f < c)
                r(d = b.call(a, a[f], f)) && (e += (d - e) / ++g);
        return g ? e : undefined
    }, d3.median = function(a, b) {
        return arguments.length > 1 && (a = a.map(b)), a = a.filter(r), a.length ? d3.quantile(a.sort(d3.ascending), .5) : undefined
    }, d3.min = function(a, b) {
        var c = -1,
            d = a.length,
            e,
    ...
    d3.bisectLeft = t.left, d3.bisect = d3.bisectRight = t.right, d3.first = function(a, b) {
        var c = 0,
            d = a.length,
            e = a[0],
            f;
    ...
    d3.ns = {
        ...
        qualify: function(a) {
            var b = a.indexOf(":"),
                c = a;
            return b >= 0 && (c = a.substring(0, b), a = a.substring(b + 1)), y.hasOwnProperty(c) ? {
                space: y[c],
                local: a
            } : a
        }
        ...
        return i == "r" && !h && (i = "g"), i = C.get(i) || E, function(a) {
            if (l && a % 1)
                return "";
            var b = a < 0 && (a = -a) ? "−" : d;
            if (j < 0) {
            ...
            if (e) {
                ...
                n < f && (a = (new Array(f - n + 1)).join(c) + a), g && (a = F(a)), a = b + a
            } else {
                g && (a = F(a)), a = b + a;
                var n = a.length;
    ...
    var B = /(?:([^{])?([<>=^]))?([+\- ])?(#)?(0)?([0-9]+)?(,)?(\.[0-9]+)?([a-zA-Z%])?/,
        ...
        G = ["y", "z", "a", "f", "p", "n", "μ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"].map(H);
    d3.formatPrefix = function(a, b) {
        var c = 0;
        return a && (a < 0 && (a *= -1), b && (a = d3.round(a, D(a, b))), c = 1 + Math.floor(1e-12 + Math.log(a) / Math.LN10), c = Math.max(-24, Math.min(24, Math.floor((c <= 0 ? c + 1 : c - 1) / 3) * 3))), G[8 + c / 3]
    };
    var I = R(2),
        J = R(3),
        K = function() {
    ...
    d3.ease = function(a) {
        ...
        return c = L.get(c) || K, d = M.get(d) || Q, N(d(c.apply(null, Array.prototype.slice.call(arguments, 1))))
        ...
        var c = a.r,
            ...
            h = b.b - e;
        return function(a) {
            return "#" + bf(Math.round(c + f * a)) + bf(Math.round(d + g * a)) + bf(Math.round(e + h * a))
        }
        ...
        var c = a.h,
            ...
            g = b.s - d,
            h = b.l - e;
        return f > 180 ? f -= 360 : f < -180 && (f += 360), function(a) {
        ...
        var c = {},
            ...
            e;
        for (e in a)
            e in b ? c[e] = ba(e)(a[e], b[e]) : d[e] = a[e];
        for (e in b)
            e in a || (d[e] = b[e]);
        return function(a) {
            for (e in c)
    ...
    d3.interpolators = [d3.interpolateObject, function(a, b) {
        ...
        return (typeof b == "string" ? bj.has(b) || /^(#|rgb\(|hsl\()/.test(b) : b instanceof be || b instanceof bl) && d3.interpolateRgb(a, b)
    }, function(a, b) {
        return !isNaN(a = +a) && !isNaN(b = +b) && d3.interpolateNumber(a, b)
    }], d3.rgb = function(a, b, c) {
        return arguments.length === 1 ? a instanceof be ? bd(a.r, a.g, a.b) : bg("" + a, bd, bm) : bd(~~a, ~~b, ~~c)
        ...
        return a = Math.pow(.7, arguments.length ? a : 1), bd(Math.floor(a * this.r), Math.floor(a * this.g), Math.floor(a * this.b))
    ...
    bj.forEach(function(a, b) {
        ...
        return arguments.length === 1 ? a instanceof bl ? bk(a.h, a.s, a.l) : bg("" + a, bh, bk) : bk(+a, +b, +c)
    }, bl.prototype.brighter = function(a) {
        return a = Math.pow(.7, arguments.length ? a : 1), bk(this.h, this.s, this.l / a)
    }, bl.prototype.darker = function(a) {
        return a = Math.pow(.7, arguments.length ? a : 1), bk(this.h, this.s, a * this.l)
    ...
    var bo = function(a, b) {
        ...
        br = bq.matchesSelector || bq.webkitMatchesSelector || bq.mozMatchesSelector || bq.msMatchesSelector || bq.oMatchesSelector,
        bs = function(a, b) {
            return br.call(a, b)
        };
    typeof Sizzle == "function" && (bo = function(a, b) {
    ...
    d3.selection = function() {
        return bB
    }, d3.selection.prototype = bt, bt.select = function(a) {
        var b = [],
            c,
            d,
            e,
        ...
        function c() {
            return this.insertBefore(document.createElementNS(this.namespaceURI, a), bo(b, this))
        }
        function d() {
            return this.insertBefore(document.createElementNS(a.space, a.local), bo(b, this))
        }
        ...
        function g(a, c) {
            ...
            if (b) {
                var r = new j,
                    ...
                    u = c.length;
                for (d = -1; ++d < e;)
                    t = b.call(p = a[d], p.__data__, d), r.has(t) ? o[u++] = p : r.set(t, p), s.push(t);
                for (d = -1; ++d < f;)
                    t = b.call(c, q = c[d], d), r.has(t) ? (m[d] = p = r.get(t), p.__data__ = q, n[d] = o[d] = null) : (n[d] = bx(q), m[d] = o[d] = null), r.remove(t);
                for (d = -1; ++d < e;)
                    r.has(s[d]) && (o[d] = a[d])
            } else {
                for (d = -1; ++d < g;)
                    p = a[d], q = c[d], p ? (p.__data__ = q, m[d] = p, n[d] = o[d] = null) : (n[d] = bx(q), m[d] = o[d] = null);
                for (; d < f; ++d)
                    n[d] = bx(c[d]), m[d] = o[d] = null;
                for (; d < l; ++d)
                    o[d] = a[d], n[d] = m[d] = null
            }
            n.update = m, n.parentNode = m.parentNode = o.parentNode = a.parentNode, h.push(n), i.push(m), k.push(o)
        }
        var c = -1,
            d = this.length,
            e,
    ...
    var bB = bn([[document]]);
    bB[0].parentNode = bq, d3.select = function(a) {
        return typeof a == "string" ? bB.select(a) : bn([[a]])
    }, d3.selectAll = function(a) {
        return typeof a == "string" ? bB.selectAll(a) : bn([e(a)])
    };
    var bD = [];
    d3.selection.enter = bC, d3.selection.enter.prototype = bD, bD.append = bt.append, bD.insert = bt.insert, bD.empty = bt.empty, bD.node = bt.node, bD.select = function(a) {
        var b = [],
            c,
            d,
            e,
    ...
    var bF = {},
        ...
        bP = bM,
        bQ = bN;
    bI.call = bt.call, d3.transition = function(a) {
        return arguments.length ? bK ? a.transition() : a : bB.transition()
    }, d3.transition.prototype = bI, bI.select = function(a) {
        var b = [],
            c,
            d,
            e;
        ...
        function d(a, d) {
            ...
            return e === bF ? (this.removeAttribute(c), null) : e && function(a) {
                this.setAttribute(c, e(a))
            }
        }
        function e(a, d) {
            var e = b.call(this, a, d, this.getAttributeNS(c.space, c.local));
            return e === bF ? (this.removeAttributeNS(c.space, c.local), null) : e && function(a) {
        ...
        return arguments.length < 3 && (c = ""), this.tween("style." + a, function(d, e) {
            ...
            return f === bF ? (this.style.removeProperty(a), null) : f && function(b) {
        ...
        return bA(this, typeof a == "function" ? function(b, c, d) {
    ...
    var bX = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function(a) {
        setTimeout(a, 17)
    };
    ...
    d3.touches = function(a, b) {
        return arguments.length < 2 && (b = Z().touches), b ? e(b).map(function(b) {
            var c = cc(a, b);
    ...
    var cx = ["#1f77b4", "#ff7f0e", "#2ca02c", "#d62728", "#9467bd", "#8c564b", "#e377c2", "#7f7f7f", "#bcbd22", "#17becf"],
        cy = ["#1f77b4", "#aec7e8", "#ff7f0e", "#ffbb78", "#2ca02c", "#98df8a", "#d62728", "#ff9896", "#9467bd", "#c5b0d5", "#8c564b", "#c49c94", "#e377c2", "#f7b6d2", "#7f7f7f", "#c7c7c7", "#bcbd22", "#dbdb8d", "#17becf", "#9edae5"],
        cz = ["#393b79", "#5254a3", "#6b6ecf", "#9c9ede", "#637939", "#8ca252", "#b5cf6b", "#cedb9c", "#8c6d31", "#bd9e39", "#e7ba52", "#e7cb94", "#843c39", "#ad494a", "#d6616b", "#e7969c", "#7b4173", "#a55194", "#ce6dbd", "#de9ed6"],
        cA = ["#3182bd", "#6baed6", "#9ecae1", "#c6dbef", "#e6550d", "#fd8d3c", "#fdae6b", "#fdd0a2", "#31a354", "#74c476", "#a1d99b", "#c7e9c0", "#756bb1", "#9e9ac8", "#bcbddc", "#dadaeb", "#636363", "#969696", "#bdbdbd", "#d9d9d9"];
    ...
    }, cQ.reverse = cR, cR.reverse = cQ, d3.svg.area = function() {
        return dj(Object)
    ...
    d3.svg.axis = function() {
        ...
        function k() {
            ...
            var d = this,
                ...
                s = x(),
                t,
                u = d3.select(window).on("mousemove.brush", A).on("mouseup.brush", C).on("touchmove.brush", A).on("touchend.brush", C).on("keydown.brush", y).on("keyup.brush", z);
            if (q)
                s[0] = e[0][0] - s[0], s[1] = e[0][1] - s[1];
            else if (n) {
                var v = +/w$/.test(n),
                    w = +/^n/.test(n);
                t = [e[1 - v][0] - s[0], e[1 - w][1] - s[1]], s[0] = e[v][0], s[1] = e[w][1]
            } else
                d3.event.altKey && (r = s.slice());
    ...
    var dB = {
        ...
        dC = [["n", "e", "s", "w", "nw", "ne", "se", "sw"], ["e", "w"], ["n", "s"], []];
    d3.behavior = {}, d3.behavior.drag = function() {
        ...
        function d() {
            ...
            function l() {
                d({
                    type: "dragend"
                }), h && (Y(), d3.event.target === e && i.on("click.drag", m, !0)), i.on("mousemove.drag", null).on("touchmove.drag", null).on("mouseup.drag", null).on("touchend.drag", null)
            }
            function m() {
            ...
            b ? (f = b.apply(c, arguments), f = [f.x - g[0], f.y - g[1]]) : f = [0, 0], Y(), d({
                type: "dragstart"
            })
        }
    ...
    d3.layout = {}, d3.layout.bundle = function() {
        ...
        return a.tick = function() {
            ...
            for (h = 0; h < d; ++h) {
                ...
                if (p = v * v + w * w)
                    p = e * r[h] * ((p = Math.sqrt(p)) - q[h]) / p, v *= p, w *= p, m.x -= v * (u = l.weight / (m.weight + l.weight)), m.y -= w * u, l.x += v * (u = 1 - u), l.y += w * u
            }
            if (u = e * j) {
                v = c[0] / 2, w = c[1] / 2, h = -1;
                if (u)
            ...
            if (i) {
                ...
                while (++h < a)
                    (k = n[h]).fixed || g.visit(t(k))
            }
            h = -1;
            while (++h < a)
                k = n[h], k.fixed ? (k.x = k.px, k.y = k.py) : (k.x -= (k.px - (k.px = k.x)) * f, k.y -= (k.py - (k.py = k.y)) * f);
            b.tick({
                type: "tick",
                alpha: e
            })
            ...
            var b,
                ...
                m;
            for (b = 0; b < e; ++b)
                (m = n[b]).index = b, m.weight = 0;
            q = [], r = [];
            for (b = 0; b < f; ++b)
                m = o[b], typeof m.source == "number" && (m.source = n[m.source]), typeof m.target == "number" && (m.target = n[m.target]), q[b] = g.call(this, m, b), r[b] = h.call(this, m, b), ++m.source.weight, ++m.target.weight;
            for (b = 0; b < e; ++b)
                m = n[b], isNaN(m.x) && (m.x = p("x", j)), isNaN(m.y) && (m.y = p("y", k)), isNaN(m.px) && (m.px = m.x), isNaN(m.py) && (m.py = m.y);
            s = [];
            if (typeof i == "function")
                for (b = 0; b < e; ++b)
                    s[b] = +i.call(this, n[b], b);
            else
                for (b = 0; b < e; ++b)
                    s[b] = i;
            return a.resume()
    ...
    d3.layout.partition = function() {
        ...
        function e(f, g) {
            var h = f.map(function(b, c) {
                ...
                j = ((typeof d == "function" ? d.apply(this, arguments) : d) - c) / d3.sum(h),
                k = d3.range(f.length);
    ...
    d3.layout.pack = function() {
        ...
        function d(d, e) {
            function h(a, c) {
                ...
                if (d && (f = d.length)) {
                    ...
                    c && (e.prelim = c._tree.prelim + b(a, c))
            }
            function i(a, b) {
            ...
            function j(a, c, d) {
                if (c) {
                    ...
                    while (g = eA(g), e = ez(e), g && e)
                        h = ez(h), f = eA(f), f._tree.ancestor = a, m = g._tree.prelim + k - e._tree.prelim - i + b(g, e), m > 0 && (eH(eI(g, a, d), a, m), i += m, j += m), k += g._tree.mod, i += e._tree.mod, l += h._tree.mod, j += f._tree.mod;
        ...
        function j(a) {
            ...
            if (b && b.length) {
                ...
                while ((o = f.length) > 0)
                    d.push(g = f[o - 1]), d.area += g.area, (k = l(d, n)) <= h ? (f.pop(), h = k) : (d.area -= d.pop().area, m(d, n, c, !1), n = Math.min(c.dx, c.dy), d.length = d.area = 0, h = Infinity);
        ...
        function k(a) {
            ...
            if (b && b.length) {
                ...
                while (f = d.pop())
                    g.push(f), g.area += f.area, f.z != null && (m(g, f.z ? c.dx : c.dy, c, !d.length), g.length = g.area = 0);
                b.forEach(k)
            }
        }
        function l(a, b) {
        ...
        function m(a, c, d, e) {
            ...
            if (c == d.dx) {
                if (e || j > d.dy)
                    j = d.dy;
                while (++f < g)
                    k = a[f], k.x = h, k.y = i, k.dy = j, h += k.dx = Math.min(d.x + d.dx - h, j ? b(k.area / j) : 0);
                k.z = !0, k.dx += d.x + d.dx - h, d.y += j, d.dy -= j
            } else {
                if (e || j > d.dx)
                    j = d.dx;
                while (++f < g)
                    k = a[f], k.x = h, k.y = i, k.dx = j, i += k.dy = Math.min(d.y + d.dy - i, j ? b(k.area / j) : 0);
    ...
    d3.geo.azimuthal = function() {
        ...
        function j(a) {
            var b = d3.geom.polygon(a[0].map(c)),
                ...
                j = a.length;
            while (++i < j)
                b = d3.geom.polygon(a[i].map(c)), d = b.area(), e = b.centroid(d < 0 ? (d *= -1, 1) : -1), f -= e[0], g -= e[1], h -= d;
            return [f, g, 6 * h]
        }
        function l(a) {
    ...
    d3.geo.circle = function() {
        ...
        function h(a) {
            var b = -1,
                ...
                l;
            while (++b < e)
                l = d.distance(j = a[b]), l < c ? (h && f.push(fb(h, j)((k - c) / (k - l))), f.push(j), g = h = null) : (h = j, !g && f.length && (f.push(fb(f[f.length - 1], h)((c - k) / (l - k))), g = h)), k = l;
    ...
    d3.geom.hull = function(a) {
        ...
        for (; g < c; ++g) {
            if (d[g].index === -1)
                continue;
            while (!ff(e[p - 2], e[p - 1], d[g].index, a))
                --p;
            e[p++] = d[g].index
        }
        var q = [];
        ...
        return a.area = function() {
            ...
            while (++d < e) {
                ...
                while (++f < g)
                    k = c[f], fg(k, h, i) ? (fg(j, h, i) || b.push(fh(j, k, h, i)), b.push(k)) : fg(j, h, i) && b.push(fh(j, k, h, i)), j = k;
                h = i
            }
            return b
        }, a
    ...
    d3.geom.delaunay = function(a) {
        ...
        if (arguments.length < 5)
            if (arguments.length === 3)
                ...
                while (++g < h)
                    f = a[g], f.x < b && (b = f.x), f.y < c && (c = f.y), f.x > d && (d = f.x), f.y > e && (e = f.y);
                var i = d - b,
                    j = e - c;
                i > j ? e = c + i : d = b + j
            }
    ...
    d3.time.format = function(a) {
        function c(c) {
            var d = [],
                ...
                h;
            while (++e < b)
                a.charCodeAt(e) == 37 && (d.push(a.substring(f, e), (h = fv[g = a.charAt(++e)]) ? h(c) : g), f = e + 1);
    ...
    var gg = [1e3, 5e3, 15e3, 3e4, 6e4, 3e5, 9e5, 18e5, 36e5, 108e5, 216e5, 432e5, 864e5, 1728e5, 6048e5, 2592e6, 7776e6, 31536e6],
        gh = [[d3.time.second, 1], [d3.time.second, 5], [d3.time.second, 15], [d3.time.second, 30], [d3.time.minute, 1], [d3.time.minute, 5], [d3.time.minute, 15], [d3.time.minute, 30], [d3.time.hour, 1], [d3.time.hour, 3], [d3.time.hour, 6], [d3.time.hour, 12], [d3.time.day, 1], [d3.time.day, 2], [d3.time.week, 1], [d3.time.month, 1], [d3.time.month, 3], [d3.time.year, 1]],
        gi = [[d3.time.format("%Y"), function(a) {
            return !0
