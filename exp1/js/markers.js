...
function attachMarkerToCountry( countryName, importance ){
	...
	if(country.exportedAmount > 0 && country.importedAmount > 0) {
	   importExportText += "arrival:&nbsp;" + numberWithCommas(country.importedAmount) +"&nbsp;flights"+ "<br />" +
	       "departure:&nbsp;"+numberWithCommas(country.exportedAmount)+"&nbsp;flights";
	} else if(country.exportedAmount > 0 && country.importedAmount == 0) {
	   importExportText += "departure:&nbsp;"+numberWithCommas(country.exportedAmount)+"&nbsp;flights"+"<br />&nbsp;";
	} else if(country.exportedAmount == 0 && country.importedAmount > 0) {
	   importExportText += "arrival:&nbsp;"+numberWithCommas(country.importedAmount)+"&nbsp;flights"+"<br />&nbsp;";
	}
