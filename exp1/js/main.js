...
var Selection = function(){
	...
	this.selectedCountry = 'HONG KONG';
...
// 			specular: 	0x333333,
	...
	selectVisualization( timeBins, '1998', ['HONG KONG'], ['Passenger','Cargo'], ['Passenger','Cargo'] );
	...
	for( var i in timeBins ){
		...
		for( var s in yearBin ){
			...
			if( exporterCountryName == countryName )
				value.exports += parseInt(set.v);
			if( importerCountryName == countryName )
				value.imports += parseInt(set.v);
		}
		history.push(value);
	}
	//console.log(history);
